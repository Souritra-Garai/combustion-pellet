...
$(BUILDDIR)/R_Matrix_Example.o : $(EXMDIR)/R_Matrix_Example.cpp $(INCDIR)/R_Matrix.hpp $(BUILDDIR)/R_Matrix.o
	@mkdir -p $(BUILDDIR);
...
$(BUILDDIR)/Q_Matrix_Example.o : $(EXMDIR)/Q_Matrix_Example.cpp $(INCDIR)/Q_Matrix.hpp $(BUILDDIR)/Q_Matrix.o
	@mkdir -p $(BUILDDIR);
...
$(BUILDDIR)/G_Matrix_Example.o : $(EXMDIR)/G_Matrix_Example.cpp $(INCDIR)/G_Matrix.hpp $(BUILDDIR)/G_Matrix.o
	@mkdir -p $(BUILDDIR);
