...
class IdealGas
{
	...
	public :
		...
		IdealGas() : _enthalpy(), _thermal_conductivity()
		{;}

		real_t getDensity(real_t temperature, real_t pressure = 1.01325E5)
		{
		...
		real_t getCp(real_t temperature)
		{
		...
		real_t getMolarDensity(real_t temperature, real_t pressure = 1.01325E5)
        { 
